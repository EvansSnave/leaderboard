...
> This is a leaderboard website where user can input their name and score.


**Leaderboard** is about implementing a new API
...
In order to run this project you need: have 'npm' package manger. Install webpack and webpack server. 
...
Run the project with webpack server.
